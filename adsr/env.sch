...
F 0 "C3" H 6415 4796 50  0000 L CNN
F 1 "4.7u" H 6415 4705 50  0000 L CNN
...
F 0 "#PWR039" H 6300 4800 50  0001 C CNN
...
F 0 "U7" H 7350 3800 50  0000 C CNN
...
F 0 "U7" H 7300 3150 50  0000 C CNN
...
F 0 "U6" H 4450 2725 50  0000 C CNN
...
F 0 "U6" H 3650 2825 50  0000 C CNN
...
F 0 "#PWR034" H 4750 6950 50  0001 C CNN
...
F 0 "R14" H 4820 6196 50  0000 L CNN
F 1 "1M" H 4820 6105 50  0000 L CNN
F 2 "Resistor_SMD:R_1206_3216Metric_Pad1.42x1.75mm_HandSolder" V 4680 6150 50  0001 C CNN
...
F 0 "R17" H 6620 2946 50  0000 L CNN
...
F 0 "R18" H 7370 2946 50  0000 L CNN
...
F 0 "U7" H 5600 6150 50  0000 C CNN
...
F 0 "U7" H 5600 6650 50  0000 C CNN
...
F 0 "Q6" H 5591 2354 50  0000 L CNN
...
F 0 "Q6" H 6091 2354 50  0000 L CNN
...
F 0 "#PWR056" H 5650 1850 50  0001 C CNN
...
F 0 "R20" H 5170 2746 50  0000 L CNN
...
F 0 "#PWR055" H 3100 3100 50  0001 C CNN
...
F 0 "#PWR038" H 2400 3100 50  0001 C CNN
...
F 0 "#PWR037" H 1650 3100 50  0001 C CNN
...
F 0 "U7" H 9608 1446 50  0000 L CNN
...
F 0 "#PWR058" H 9550 2100 50  0001 C CNN
...
F 0 "#PWR057" H 9550 650 50  0001 C CNN
...
F 0 "D4" V 4496 5820 50  0000 R CNN
F 1 "D" V 4405 5820 50  0000 R CNN
F 2 "Diode_THT:D_A-405_P2.54mm_Vertical_AnodeUp" H 4450 5900 50  0001 C CNN
...
F 0 "RV3" H 4681 6946 50  0000 R CNN
F 1 "R_SUSTAIN" H 4681 6855 50  0000 R CNN
F 2 "synth:Potentiometer_Alpha_RD902F-40-00D_Dual_Vertical" H 4750 6900 50  0001 C CNN
...
F 0 "C10" H 8865 1146 50  0000 L CNN
...
F 0 "#PWR0109" H 8750 1450 50  0001 C CNN
...
F 0 "#PWR0110" H 8750 550 50  0001 C CNN
...
F 0 "#PWR0111" H 8350 650 50  0001 C CNN
...
F 0 "#PWR0112" H 8350 1100 50  0001 C CNN
...
REF_RAW
Text HLabel 2100 6450 2    50   Input ~ 0
OUT
...
F 0 "J11" H 1250 7200 50  0000 L CNN
...
F 0 "J12" H 1808 7231 50  0000 C CNN
...
F 0 "#PWR0115" H 1050 7000 50  0001 C CNN
...
F 0 "#PWR0116" H 2050 7000 50  0001 C CNN
